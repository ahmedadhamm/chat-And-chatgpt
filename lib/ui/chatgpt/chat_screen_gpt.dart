...
import 'chat_message_gpt.dart';

class ChatScreenGpt extends StatefulWidget {
  static const String routeName = 'chatGpt';
...
class _ChatScreenGptState extends State<ChatScreenGpt> {
  ...
  final List<ChatMessageGpt> _messages = [];
  late OpenAI? chatGPT;
  ...
  void _sendMessage() async {
    ...
    ChatMessageGpt message = ChatMessageGpt(
  ...
  void insertNewData(String response, {bool isImage = false}) {
    ChatMessageGpt botMessage = ChatMessageGpt(
      text: response,
      sender: "bot",
      isImage: isImage,
    );
